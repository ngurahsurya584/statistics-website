...
@section('edit')
    <form method="POST" action="/edit/{{ $anggota->id }} id=" forminput"> {{-- form akan mengarah ke route edit dengan method put --}}
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="{{ $anggota->nama }}" id="nama" placeholder="Nama Mahasiswa"
                name="nama">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" value="{{ $anggota->skor }}" id="skor" placeholder="Skor"
                name="skor">
